...
import { Plus, Trash2, UserRound, Building2 } from 'lucide-react'
...
export function Cadastros() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
      {/*
        Antes existia também um card "Captadores" (tabela `captadores`), redundante com
        Consultores — na operação são a mesma pessoa. O cadastro dessa lista continua
        disponível inline no card do lead / detalhe do paciente (campo "Consultor").
      */}
      <ConsultoresCard />
      <HospitaisCard />
    </div>
